...
var _traningSwiper = require("./modules/traning-swiper");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _traningSwiper.initTraningSwiper)();
    (0, _reviewsSwiper.initReviewsSwiper)();
    (0, _advantagesSwiper.initSwiperAdvantages)();
...
},{"./modules/advantages-swiper":2,"./modules/form-validate/form":4,"./modules/gallery-swiper":10,"./modules/hero-swiper":11,"./modules/modals/init-modals":12,"./modules/open-menu":14,"./modules/reviews-swiper":15,"./modules/tours-swiper":16,"./modules/traning-swiper":17,"./modules/video":18,"./utils/ios-vh-fix":21}],2:[function(require,module,exports){
"use strict";
...
var buttonNext = document.querySelector('[data-advantages="button-next"]');
var buttonPrev = document.querySelector('[data-advantages="button-prev"]');
var initSwiperAdvantages = exports.initSwiperAdvantages = function initSwiperAdvantages() {
  ...
  resizableSwiper('(min-width: 1200px)', '[data-advantages="advantages-slider"]', {
    loop: false,
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
...
var initGallerySwiper = exports.initGallerySwiper = function initGallerySwiper() {
  var buttonNext = document.querySelector('[data-gallery="button-next"]');
  var buttonPrev = document.querySelector('[data-gallery="button-prev"]');
  var slides = document.querySelectorAll('[data-gallery="gallery-item"]');
  var slidesArr = _toConsumableArray(slides);
  var swiper = new window.Swiper('[data-gallery="gallery-slider"]', {
    loop: true,
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
...
var initSwiper = exports.initSwiper = function initSwiper() {
  var slides = document.querySelectorAll('[data-hero="hero-item"]');
  var slidesArr = _toConsumableArray(slides);
  var swiper = new window.Swiper('[data-hero="hero-slider"]', {
    loop: true,
    pagination: {
...
var navMain = document.querySelector('[data-header="main-nav"]');
var navToggle = document.querySelector('[data-header="button-menu"]');
var header = document.querySelector('[data-header="header-open"]');
var headerContainer = document.querySelector('[data-header="header-container"]');
var heroContainer = document.querySelector('[data-hero="hero-container"]');
var wrapper = document.querySelector('[data-wrapper="off-scroll"]');
...
var initReviewsSwiper = exports.initReviewsSwiper = function initReviewsSwiper() {
  var buttonNext = document.querySelector('[data-reviews="button-next"]');
  var buttonPrev = document.querySelector('[data-reviews="button-prev"]');
  var slides = document.querySelectorAll('[data-reviews="reviews-item"]');
  var slidesArr = _toConsumableArray(slides);
...
var initToursSwiper = exports.initToursSwiper = function initToursSwiper() {
  var buttonNext = document.querySelector('[data-tours="button-next"]');
  var buttonPrev = document.querySelector('[data-tours="button-prev"]');
  var slides = document.querySelectorAll('[data-tours="tours-item"]');
  var slidesArr = _toConsumableArray(slides);
  var swiper = new window.Swiper('[data-tours="tours-slider"]', {
    loop: false,
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
...
exports.initTraningSwiper = void 0;
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var initTraningSwiper = exports.initTraningSwiper = function initTraningSwiper() {
  var buttonNext = document.querySelector('[data-instructors="button-next"]');
  var buttonPrev = document.querySelector('[data-instructors="button-prev"]');
  var slides = document.querySelectorAll('[data-instructors="instructors-item"]');
  var slidesArr = _toConsumableArray(slides);
  var swiper = new window.Swiper('[data-instructors="instructors-slider"]', {
    loop: false,
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
